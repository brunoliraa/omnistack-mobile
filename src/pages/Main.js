...
export default function Main({navigation}){
    ...
    async function handleLike(){
        //pega o primeiro user da lista e cria uma lista com o resto dos users
        const [user, ...resto] = users;
        await api.post(`/devs/${user._id}/likes`,null,{
            headers:{user:id},
        })
        //passa a nova lista com o resto dos users
        setUsers(resto);
    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            <Image style={styles.logo} source={tindev}/>  
            </TouchableOpacity>
            ...
            {users.length >0 && (
                  ...
                  <TouchableOpacity onPress={handleDisike} style={styles.button}>
                      <Text>Dislike</Text>
                  </TouchableOpacity>
              </View>    
            )}           
